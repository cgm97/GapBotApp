...
const CommandPage = () => {
  ...
  const listLoaItems = [
    ...
    { id: 29, prefix: <>.견적 <span className="text-xs text-blue-500 dark:text-blue-300">(.내견적)</span></>, img: '/img/cmd/ruswjr.png', description: '예시) .견적 무기 10 15 | .견적 벙어구 10 15 | .견적 캐릭터명 25 | .내견적 25 | 단계는 10 ~ 25까지만 지원하며, 이미 캐릭터가 모두 25강 일 경우 오류 발생합니다. | 로아베스팅 지원 - 재련 견적 확인' },
