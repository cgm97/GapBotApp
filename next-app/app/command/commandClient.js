...
const CommandPage = () => {
  ...
  const listLoaItems = [
    ...
    { id: 29, prefix: <>.견적 <span className="text-xs text-blue-500 dark:text-blue-300">(.내견적)</span></>, img: '/img/cmd/ruswjr.png', description: '.내견적 목표단계 OR .견적 캐릭터명 목표단계 OR .견적 시작단계 목표단계 | 로아베스팅 지원 - 재련 견적 확인' },
