...
import guildImg from '../img/guild.png';
...
const Character = () => {
    ...
    const fetchCharacterData = useCallback(async () => {
        ...
        try {
            const response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/character/search`, {
                params: { nickName },
            });
    ...
    const handleRenew = async () => {
        ...
        try {
            const response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/character/renew`, {
                params: { nickName },
            });
            ...
            <div className="group-info">
                <div className="character">
                    ...
                    <div className="character-info">
                        ...
                        <p className="character-name">Lv.{profile.CHARACTER_LEVEL}&nbsp;{profile.NICKNAME}</p>
